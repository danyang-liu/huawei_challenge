...
#         predict_flavor_num[index] = int((predict_flavor_num[index]*float(predict_data_delta+1))/train_days_delta)
    ...
    predict_weekday_weekend_index = float(predict_weekend_count+1.2*predict_weekday_count)/float(predict_weekend_count+predict_weekday_count)
    train_weekday_weekend_index = float(train_weekend_count + 1.2 * train_weekday_count) / float(train_weekend_count + train_weekday_count)
