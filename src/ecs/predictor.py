...
#         predict_flavor_num[index] = int(predict_flavor_num[index]*predict_weekday_weekend_index/train_weekday_weekend_index)
    ...
    for i in range(flavor_type_num):
        ...
        predict_flavor_num_3_zhishu.append(1.02*sum(flavor_num[i][-(predict_data_delta + 1):]))
        pass
    for i in range(flavor_type_num):
    ...
    for i in range(flavor_type_num):
        predict_flavor_num.append(int(1.1*predict_flavor_num_3_zhishu[i]-0.1*predict_flavor_num_jubu[i]))
